/* spectrum.c: Generic Spectrum routines
   ...
   $Id: spectrum.c,v 1.63 2004/06/26 00:55:39 fredm Exp $
...
spectrum_frame( void )
{
  ...
  //ui_error(UI_ERROR_ERROR,"Yep: EventFrame");
  ...
  //ui_error(UI_ERROR_ERROR,"Yep: SoundFrame");
...
/*  if(sound_enabled) {
  ...
  //ui_error(UI_ERROR_ERROR,"Yep: Display Frame");
  if(display_frame()) return 1;
  //ui_error(UI_ERROR_ERROR,"Yep: FrameE");
  //printer_frame();
